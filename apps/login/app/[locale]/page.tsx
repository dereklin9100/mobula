...
import { Field, FieldDescription, FieldGroup, FieldLabel, FieldSeparator } from "@repo/ui/components/base/field"
  ...
  return (
    <div className="flex flex-col gap-6">
            ...
            <FieldGroup>
              ...
              <Field>
                <div className="flex items-center">
                  <FieldLabel htmlFor="password">{t("form.password.label")}</FieldLabel>
                  <a
                    href="#"
              ...
              <FieldDescription className="text-center">
                {t("footer.noAccount")} <a href="#">{t("footer.signUp")}</a>
              </FieldDescription>
            </FieldGroup>
          </form>
        </CardContent>
      ...
      <FieldDescription className="px-6 text-center">
        {t("legal.prefix")} <a href="#">{t("legal.terms")}</a>{" "}
        {t("legal.and")} <a href="#">{t("legal.privacy")}</a>.
      </FieldDescription>
    </div>
  )
}
